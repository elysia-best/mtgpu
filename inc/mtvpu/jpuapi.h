...
typedef enum {
    ...
    ENABLE_JPG_LOGGING,      /**< This command activates message logging once JPU_DecOpen() or JPU_EncOpen() is called. */
    DISABLE_JPG_LOGGING,     /**< This command deactivates message logging. (default) */
    JPG_CMD_END
} JpgCommand;
...
*/
typedef enum {
    JPG_MIRDIR_NONE, /**< No mirroring */
    JPG_MIRDIR_VER,  /**< Vertical mirroring */
    JPG_MIRDIR_HOR,  /**< Horizontal mirroring */
    JPG_MIRDIR_HOR_VER /**< Horizontal and veritical mirroring */
} JpgMirrorDirection;
...
*/
typedef enum {
    JPG_FORMAT_420 = 0, /**< YUV420 format */
    JPG_FORMAT_422 = 1, /**< YUV422 format */
    JPG_FORMAT_440 = 2, /**< YUV440 format */
    JPG_FORMAT_444 = 3, /**< YUV444 format */
    JPG_FORMAT_400 = 4, /**< YUV400 format */
    JPG_FORMAT_MAX
} FrameFormat;
...
*/
typedef enum {
    JPG_CBCR_SEPARATED = 0, /**< Cb data and Cr data are located in each separate plane. */
    JPG_CBCR_INTERLEAVE, /**< Chroma data are interleaved in Cb and Cr order. */
    JPG_CRCB_INTERLEAVE  /**< Chroma data are interleaved in Cr and Cb order. */
} CbCrInterLeave;
...
typedef enum {
    ...
    PACKED_JPG_FORMAT_422_YUYV,  /**< This is YUV422 packed format with YUYV component order. */
    PACKED_JPG_FORMAT_422_UYVY,  /**< This is YUV422 packed format with UYVY component order. */
    PACKED_JPG_FORMAT_422_YVYU,  /**< This is YUV422 packed format with YVYU component order. */
    PACKED_JPG_FORMAT_422_VYUY,  /**< This is YUV422 packed format with VYUY component order. */
    PACKED_JPG_FORMAT_444,       /**< This is YUV444 packed format.  */
...
typedef enum {
    ...
    INT_JPU_STOP_DONE = 8,    /**< This interrupt indicates the completion of stopping  */     
#endif
...
*/
typedef struct {
    JpgFrameBuffer* sourceFrame; /**< This member must represent the frame buffer containing source image to be encoded. */
} JpgEncParam;
...
*/
int JPU_GetOpenInstanceNum(int coreIdx);
/**
...
@endverbatim
*/
    JpgRet JPU_SWReset(int coreIdx);
