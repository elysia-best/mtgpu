...
// Description  : 
//-----------------------------------------------------------------------------
#ifndef __JPUAPI_UTIL_H__
#define __JPUAPI_UTIL_H__
...
JpgRet GetJpgInstance(int coreIdx, JpgInst ** ppInst);
...
int JpegDecodeHeader(int coreIdx, JpgDecInfo * jpg);
int JpgDecQMatTabSetUp(int coreIdx, JpgDecInfo *jpg, int instRegIndex);
...
JpgRet JpgEnterLock(int coreIdx);
JpgRet JpgLeaveLock(int coreIdx);
JpgRet JpgSetClockGate(int coreIdx, Uint32 on);

JpgInst *GetJpgPendingInstEx(int coreIdx);
void SetJpgPendingInstEx(int coreIdx, JpgInst *inst);
void ClearJpgPendingInstEx(int coreIdx);
