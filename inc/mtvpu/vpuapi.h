...
/**
@verbatim
This command sets the root page table address corresponding to the next decoding/encoding command. 
The argument `parameter` is interpreted as a RootPageTableInfo which denotes the root page table address and length.
The address will be set to VPU register and nofify VPU FW with the next command.
The command can be called multiple times. The last set before decode/encoder command will take effect. 
...
// For Root Page Table Info
/**
* @brief    This is a data structure for representing root page table address and length
*/
typedef struct {
...
/**
* @brief    This function returns the mmu context id of instances opened.
* @return   The mmu context id of the instance
*/
Uint32 VPU_GetMmuCtxId(
    VpuHandle handle          /**< [Input] A decoder handle obtained from VPU_DecOpen() */
    );
